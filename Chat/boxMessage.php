...
?>
    ...
    <div class=" d-flex fixed-bottom mx-auto  text-center p-3">
        <a class="btn btn-primary  mx-auto" href="login.php">Login</a> <br>
        <a class="btn btn-info  mx-auto" href="regester.php">Enregistrement</a> <br>
        <a class="btn btn-warning  mx-auto" href="index.php">Page d'Accueil</a>
    </div>
