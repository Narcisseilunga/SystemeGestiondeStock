...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_image)){
      ...
      $insert = "INSERT INTO products(nom, prix, image) VALUES('$product_name', '$product_price', '$product_image')";
...
<head>
   ...
   <title>Full Stack Dev - Tutoriel</title>
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
         <h3>Ajouter un nouveau produits</h3>
         <input type="text" placeholder="Entrer le nom du produit" name="product_name" class="box">
         <input type="number" placeholder="Entrer le prix du produits" name="product_price" class="box">
