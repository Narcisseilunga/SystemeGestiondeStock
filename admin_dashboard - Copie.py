...
class StockManager:
    def __init__(self, root_win):
        ...
        sales_btn.pack(side=TOP, fill=X)
        cam_btn = Button(menu_frame, text="Cameras", command=self.cameras, **button_style)
        cam_btn.pack(side=TOP, fill=X)
    ...
    def cameras(self):
        subprocess.run(['python', 'projetferme/surveillance2.py'])
